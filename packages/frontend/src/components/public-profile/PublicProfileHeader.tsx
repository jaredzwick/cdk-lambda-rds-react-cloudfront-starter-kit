    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex flex-col space-y-6 sm:space-y-0 sm:flex-row sm:items-start sm:gap-6">
        ...
        <div className="hidden sm:block">
          <button className="whitespace-nowrap px-6 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-md hover:bg-indigo-500">
            Book Session
          </button>
        </div>
      </div>
      ...
      <div className="mt-6 sm:hidden">
        <button className="w-full px-6 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-md hover:bg-indigo-500">
          Book Session
        </button>
      </div>
    </div>
